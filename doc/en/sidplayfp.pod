...
Set the caps for 6581 model. 'o' for old 2200pF caps mounted
on ASSY 326298 producing a lower cutoff, 'n' for standard 470pF caps
and 'g' for 'Galway' 330pF caps with higher cutoff.

=item B<-of>I<< <num> >>

If available controls the wave offset for the 6581 model in the ReSIDfp
...
=item Home page: L<https://github.com/libsidplayfp/sidplayfp>
