...
#if LIBSIDPLAYFP_VERSION_MAJ > 3 || (LIBSIDPLAYFP_VERSION_MAJ == 3 && LIBSIDPLAYFP_VERSION_MIN >= 1)
#  define FEAT_RESID_NEW_TUNABLES
#endif

#if LIBSIDPLAYFP_VERSION_MAJ > 3 || (LIBSIDPLAYFP_VERSION_MAJ == 3 && LIBSIDPLAYFP_VERSION_MIN >= 2)
#  define FEAT_RESID_CAPS_TUNABLE
#endif
